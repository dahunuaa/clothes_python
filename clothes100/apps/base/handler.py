...
from clothes100.bootstrap import exceptions
from clothes100.libs import utils
from clothes100.libs.oauthlib import validate_token
from clothes100.libs.asynclib import AsyncUtils
from clothes100.libs.options import config
from .model import BaseModel

try:
    import importlib
except:
    from clothes100.libs import importlib
...
class APIHandler(BaseAPIHandler):
    ...
    def finish(self, chunk=None, notification=None, origin=False, status_code=200):
        ...
        if callback:
            ...
            self.set_header("Content-Type", "application/json; charset=UTF-8")
            self.set_header("Server", "clothes100 API server/v0.1.0")
