...
import clothes100.libs.mongolib as mongo
import clothes100.libs.utils as utils
import sys
import inspect
import traceback

from bson.son import SON
from clothes100.libs.datatypelib import StrDT, DataTypeError, DatetimeDT
from clothes100.libs.configlib import Config, ConfigList
from clothes100.libs.options import config as base_config
...
class BaseModel(object):
    ...
    def get_model(cls, model_name):
        try:
            ...
            model_name = 'clothes100.apps.%s.model' % (app_name)
