...
import clothes100.bootstrap
from clothes100.libs.loglib import get_logger


class Application(web.Application):
    def __init__(self, type):
        from clothes100.bootstrap.urls import get_components
...
def run_main():
    try:
        from clothes100.libs.timerlib import run_gps_timer,run_http_timer
...
def run_ftp_start():
    from clothes100.libs.ftplib import run_ftp
    try:
        run_ftp()
    except:
        print(traceback.format_exc())
